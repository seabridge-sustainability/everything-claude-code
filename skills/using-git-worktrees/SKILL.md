...
description: Local wrapper for upstream Superpowers using-git-worktrees. Use when the Superpowers using-git-worktrees methodology is requested directly in SeaBridgeAI; load the canonical local reference at vendor\superpowers\skills\using-git-worktrees\SKILL.md and preserve SeaBridgeAI approval gates.
---

# using-git-worktrees

Canonical upstream Superpowers skill:
C:\Users\adelm\SeaBridgeAI\everything-claude-code\vendor\superpowers\skills\using-git-worktrees\SKILL.md
