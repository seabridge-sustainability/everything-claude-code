---
name: brainstorming
description: Local wrapper for upstream Superpowers brainstorming. Use when the Superpowers brainstorming methodology is requested directly in SeaBridgeAI; load the canonical local reference at vendor\superpowers\skills\brainstorming\SKILL.md and preserve SeaBridgeAI approval gates.
---

# brainstorming

Canonical upstream Superpowers skill:
C:\Users\adelm\SeaBridgeAI\everything-claude-code\vendor\superpowers\skills\brainstorming\SKILL.md
