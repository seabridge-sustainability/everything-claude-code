...
1. **Identify target code** Ã¢â‚¬â€ Find the function, class, or module to test
2. **Write a Kotest spec** Ã¢â‚¬â€ Choose a spec style (StringSpec, FunSpec, BehaviorSpec) matching the test scope
3. **Mock dependencies** Ã¢â‚¬â€ Use MockK to isolate the unit under test
...
- **Kotest specs** Ã¢â‚¬â€ StringSpec, FunSpec, BehaviorSpec, DescribeSpec examples in [Kotest Spec Styles](#kotest-spec-styles)
- **Mocking** Ã¢â‚¬â€ MockK setup, coroutine mocking, argument capture in [MockK](#mockk)
- **TDD walkthrough** Ã¢â‚¬â€ Full RED/GREEN/REFACTOR cycle with EmailValidator in [TDD Workflow for Kotlin](#tdd-workflow-for-kotlin)
- **Coverage** Ã¢â‚¬â€ Kover configuration and commands in [Kover Coverage](#kover-coverage)
- **Ktor testing** Ã¢â‚¬â€ testApplication setup in [Ktor testApplication Testing](#ktor-testapplication-testing)
