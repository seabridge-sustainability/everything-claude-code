...
description: Callable wrapper for sea-initiatives-action-center. Load the canonical SeaBridgeAI skill body from everything-claude-code\skills\sea-initiatives-action-center\SKILL.md.
---

# sea-initiatives-action-center

Canonical skill:
C:\Users\adelm\SeaBridgeAI\everything-claude-code\skills\sea-initiatives-action-center\SKILL.md
