...
description: Callable wrapper for sea-task-queue-execution. Load the canonical SeaBridgeAI skill body from everything-claude-code\skills\sea-task-queue-execution\SKILL.md.
---

# sea-task-queue-execution

Canonical skill:
C:\Users\adelm\SeaBridgeAI\everything-claude-code\skills\sea-task-queue-execution\SKILL.md
