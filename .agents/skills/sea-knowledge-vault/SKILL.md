...
description: Callable wrapper for sea-knowledge-vault. Load the canonical SeaBridgeAI skill body from everything-claude-code\skills\sea-knowledge-vault\SKILL.md.
---

# sea-knowledge-vault

Canonical skill:
C:\Users\adelm\SeaBridgeAI\everything-claude-code\skills\sea-knowledge-vault\SKILL.md
