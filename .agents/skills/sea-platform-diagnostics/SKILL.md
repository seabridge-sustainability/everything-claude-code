...
description: Callable wrapper for sea-platform-diagnostics. Load the canonical SeaBridgeAI skill body from everything-claude-code\skills\sea-platform-diagnostics\SKILL.md.
---

# sea-platform-diagnostics

Canonical skill:
C:\Users\adelm\SeaBridgeAI\everything-claude-code\skills\sea-platform-diagnostics\SKILL.md
