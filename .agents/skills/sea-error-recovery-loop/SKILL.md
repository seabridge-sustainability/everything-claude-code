...
description: Callable wrapper for sea-error-recovery-loop. Load the canonical SeaBridgeAI skill body from everything-claude-code\skills\sea-error-recovery-loop\SKILL.md.
---

# sea-error-recovery-loop

Canonical skill:
C:\Users\adelm\SeaBridgeAI\everything-claude-code\skills\sea-error-recovery-loop\SKILL.md
