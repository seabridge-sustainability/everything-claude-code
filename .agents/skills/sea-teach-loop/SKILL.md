---
name: sea-teach-loop
description: Callable wrapper for sea-teach-loop. Load the canonical SeaBridgeAI skill body from everything-claude-code\skills\sea-teach-loop\SKILL.md.
---

# sea-teach-loop

Canonical skill:
C:\Users\adelm\SeaBridgeAI\everything-claude-code\skills\sea-teach-loop\SKILL.md
