...
description: Callable wrapper for sea-reporting-no-touch. Load the canonical SeaBridgeAI skill body from everything-claude-code\skills\sea-reporting-no-touch\SKILL.md.
---

# sea-reporting-no-touch

Canonical skill:
C:\Users\adelm\SeaBridgeAI\everything-claude-code\skills\sea-reporting-no-touch\SKILL.md
