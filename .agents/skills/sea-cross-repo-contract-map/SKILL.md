...
description: Callable wrapper for sea-cross-repo-contract-map. Load the canonical SeaBridgeAI skill body from everything-claude-code\skills\sea-cross-repo-contract-map\SKILL.md.
---

# sea-cross-repo-contract-map

Canonical skill:
C:\Users\adelm\SeaBridgeAI\everything-claude-code\skills\sea-cross-repo-contract-map\SKILL.md
