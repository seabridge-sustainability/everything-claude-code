...
description: Local wrapper for upstream Superpowers using-superpowers. Use when the Superpowers using-superpowers methodology is requested directly in SeaBridgeAI; load the canonical local reference at vendor\superpowers\skills\using-superpowers\SKILL.md and preserve SeaBridgeAI approval gates.
---

# using-superpowers

Canonical upstream Superpowers skill:
C:\Users\adelm\SeaBridgeAI\everything-claude-code\vendor\superpowers\skills\using-superpowers\SKILL.md
