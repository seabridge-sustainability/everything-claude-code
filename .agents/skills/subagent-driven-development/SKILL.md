...
description: Local wrapper for upstream Superpowers subagent-driven-development. Use when the Superpowers subagent-driven-development methodology is requested directly in SeaBridgeAI; load the canonical local reference at vendor\superpowers\skills\subagent-driven-development\SKILL.md and preserve SeaBridgeAI approval gates.
---

# subagent-driven-development

Canonical upstream Superpowers skill:
C:\Users\adelm\SeaBridgeAI\everything-claude-code\vendor\superpowers\skills\subagent-driven-development\SKILL.md
