...
description: Callable wrapper for sea-integration-health-review. Load the canonical SeaBridgeAI skill body from everything-claude-code\skills\sea-integration-health-review\SKILL.md.
---

# sea-integration-health-review

Canonical skill:
C:\Users\adelm\SeaBridgeAI\everything-claude-code\skills\sea-integration-health-review\SKILL.md
