...
$checks = @(
    ...
    @{ Path = "everything-claude-code\references\matt-pocock-skills\README.md"; Pattern = "Goal Protocol Default" },
    @{ Path = "everything-claude-code\references\matt-pocock-skills\CLAUDE.md"; Pattern = "Goal Protocol Default" },
