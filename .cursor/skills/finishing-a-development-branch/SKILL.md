...
description: Local wrapper for upstream Superpowers finishing-a-development-branch. Use when the Superpowers finishing-a-development-branch methodology is requested directly in SeaBridgeAI; load the canonical local reference at vendor\superpowers\skills\finishing-a-development-branch\SKILL.md and preserve SeaBridgeAI approval gates.
---

# finishing-a-development-branch

Canonical upstream Superpowers skill:
C:\Users\adelm\SeaBridgeAI\everything-claude-code\vendor\superpowers\skills\finishing-a-development-branch\SKILL.md
...
C:\Users\adelm\SeaBridgeAI\everything-claude-code\skills\sea-senior-dev-workflow\SKILL.md
