...
Access to 75 agents, 384 skills, and 96 legacy command shims, plus hooks, rules, memory, continuous learning, and AgentShield security scanning. The agents are specialized for planning, review, build repair, security, architecture, and domain work.

| Included         |       Count | What it gives you                                                                    |
| ---------------- | ----------: | ------------------------------------------------------------------------------------ |
| Agents           |   75 agents | Planning, review, build repair, security, architecture, and domain work              |
| Skills           |  384 skills | TDD, research, security, docs, frontend, data, ML, operations, and more              |
