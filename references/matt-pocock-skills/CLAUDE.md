...
## Local Development Safety Policy

Automatic enforcement hooks have been removed from this repository. Agents should follow normal safe-development practices instead.

Agents must still ask for explicit confirmation before:
- deleting files or directories broadly
- wiping databases
- deleting production data
- modifying secrets or credentials
- destroying cloud resources
- deploying to production
- force-pushing or rewriting shared branch history

Agents should not block normal local development work because a removed local enforcement hook is unavailable.
