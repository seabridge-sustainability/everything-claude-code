---
name: writing-plans
description: Local wrapper for upstream Superpowers writing-plans. Use when the Superpowers writing-plans methodology is requested directly in SeaBridgeAI; load the canonical local reference at vendor\superpowers\skills\writing-plans\SKILL.md and preserve SeaBridgeAI approval gates.
---

# writing-plans

Canonical upstream Superpowers skill:
C:\Users\adelm\SeaBridgeAI\everything-claude-code\vendor\superpowers\skills\writing-plans\SKILL.md
