...
description: Local wrapper for upstream Superpowers systematic-debugging. Use when the Superpowers systematic-debugging methodology is requested directly in SeaBridgeAI; load the canonical local reference at vendor\superpowers\skills\systematic-debugging\SKILL.md and preserve SeaBridgeAI approval gates.
---

# systematic-debugging

Canonical upstream Superpowers skill:
C:\Users\adelm\SeaBridgeAI\everything-claude-code\vendor\superpowers\skills\systematic-debugging\SKILL.md
