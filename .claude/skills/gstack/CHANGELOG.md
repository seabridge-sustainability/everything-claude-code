...
## [0.15.4.0] - 2026-04-03 Ã¢â‚¬â€ Autoplan DX Integration + Docs
...
- **Autoplan pipeline order.** Now CEO Ã¢â€ â€™ Design Ã¢â€ â€™ Eng Ã¢â€ â€™ DX (was CEO Ã¢â€ â€™ Design Ã¢â€ â€™ Eng). DX runs last because it benefits from knowing the architecture.

## [0.15.3.0] - 2026-04-03 Ã¢â‚¬â€ Developer Experience Review
...
## [0.15.2.1] - 2026-04-02 Ã¢â‚¬â€ Setup Runs Migrations
...
## [0.15.2.0] - 2026-04-02 Ã¢â‚¬â€ Voice-Friendly Skill Triggers
...
## [0.15.1.0] - 2026-04-01 Ã¢â‚¬â€ Design Without Shotgun
...
## [0.15.0.0] - 2026-04-01 Ã¢â‚¬â€ Session Intelligence
...
## [0.14.6.0] - 2026-03-31 Ã¢â‚¬â€ Recursive Self-Improvement
...
## [0.14.5.0] - 2026-03-31 Ã¢â‚¬â€ Ship Idempotency + Skill Prefix Fix
...
## [0.14.4.0] - 2026-03-31 Ã¢â‚¬â€ Review Army: Parallel Specialist Reviewers
...
## [0.14.3.0] - 2026-03-31 Ã¢â‚¬â€ Always-On Adversarial Review + Scope Drift + Plan Mode Design Tools
...
## [0.14.2.0] - 2026-03-30 Ã¢â‚¬â€ Sidebar CSS Inspector + Per-Tab Agents
...
## [0.14.1.0] - 2026-03-30 Ã¢â‚¬â€ Comparison Board is the Chooser

The design comparison board now always opens automatically when reviewing variants. No more inline image + "which do you prefer?" Ã¢â‚¬â€ the board has rating controls, comments, remix/regenerate buttons, and structured feedback output. That's the experience. All 3 design skills (/plan-design-review, /design-shotgun, /design-consultation) get this fix.
...
- **Serve-failure fallback improved.** If the comparison board server can't start, variants are shown inline via Read tool before asking for preferences Ã¢â‚¬â€ you're no longer choosing blind.
...
## [0.14.0.0] - 2026-03-30 Ã¢â‚¬â€ Design to Code
...
## [0.13.10.0] - 2026-03-29 Ã¢â‚¬â€ Office Hours Gets a Reading List
...
## [0.13.9.0] - 2026-03-29 Ã¢â‚¬â€ Composable Skills
...
## [0.13.8.0] - 2026-03-29 Ã¢â‚¬â€ Security Audit Round 2
...
## [0.13.7.0] - 2026-03-29 Ã¢â‚¬â€ Community Wave
...
## [0.13.6.0] - 2026-03-29 Ã¢â‚¬â€ GStack Learns
...
## [0.13.5.1] - 2026-03-29 Ã¢â‚¬â€ Gitignore .factory
...
## [0.13.5.0] - 2026-03-29 Ã¢â‚¬â€ Factory Droid Compatibility
...
## [0.13.4.0] - 2026-03-29 Ã¢â‚¬â€ Sidebar Defense
...
## [0.13.3.0] - 2026-03-28 Ã¢â‚¬â€ Lock It Down
...
## [0.13.2.0] - 2026-03-28 Ã¢â‚¬â€ User Sovereignty
...
## [0.13.1.0] - 2026-03-28 Ã¢â‚¬â€ Defense in Depth
...
## [0.13.0.0] - 2026-03-27 Ã¢â‚¬â€ Your Agent Can Design Now
...
## [0.12.12.0] - 2026-03-27 Ã¢â‚¬â€ Security Audit Compliance
...
## [0.12.11.0] - 2026-03-27 Ã¢â‚¬â€ Skill Prefix is Now Your Choice
...
## [0.12.10.0] - 2026-03-27 Ã¢â‚¬â€ Codex Filesystem Boundary
...
## [0.12.9.0] - 2026-03-27 Ã¢â‚¬â€ Community PRs: Faster Install, Skill Namespacing, Uninstall
...
## [0.12.8.1] - 2026-03-27 Ã¢â‚¬â€ zsh Glob Compatibility
...
## [0.12.8.0] - 2026-03-27 Ã¢â‚¬â€ Codex No Longer Reviews the Wrong Project
...
## [0.12.7.0] - 2026-03-27 Ã¢â‚¬â€ Community PRs + Security Hardening
...
## [0.12.6.0] - 2026-03-27 Ã¢â‚¬â€ Sidebar Knows What Page You're On
...
## [0.12.5.1] - 2026-03-27 Ã¢â‚¬â€ Eng Review Now Tells You What to Parallelize
...
## [0.12.5.0] - 2026-03-26 Ã¢â‚¬â€ Fix Codex Hangs: 30-Minute Waits Are Gone
...
## [0.12.4.0] - 2026-03-26 Ã¢â‚¬â€ Full Commit Coverage in /ship
...
## [0.12.3.0] - 2026-03-26 Ã¢â‚¬â€ Voice Directive: Every Skill Sounds Like a Builder
...
## [0.12.2.0] - 2026-03-26 Ã¢â‚¬â€ Deploy with Confidence: First-Run Dry Run
...
## [0.12.1.0] - 2026-03-26 Ã¢â‚¬â€ Smarter Browsing: Network Idle, State Persistence, Iframes
...
## [0.12.0.0] - 2026-03-26 Ã¢â‚¬â€ Headed Mode + Sidebar Agent
...
- **`/ship` no longer tells you to "run /review first."** Ship runs its own pre-landing review in Step 3.5 Ã¢â‚¬â€ asking you to run the same review separately was redundant. The gate is removed; ship just does it.
- **`/land-and-deploy` now checks all 8 review types.** Previously missed `review`, `adversarial-review`, and `codex-plan-review` Ã¢â‚¬â€ if you only ran `/review` (not `/plan-eng-review`), land-and-deploy wouldn't see it.
...
- **GitLab support for `/retro` and `/ship`.** You can now run `/ship` on GitLab repos Ã¢â‚¬â€ it creates merge requests via `glab mr create` instead of `gh pr create`. `/retro` detects default branches on both platforms. All 11 skills using `BASE_BRANCH_DETECT` automatically get GitHub, GitLab, and git-native fallback detection.
- **GitHub Enterprise and self-hosted GitLab detection.** If the remote URL doesn't match `github.com` or `gitlab`, gstack checks `gh auth status` / `glab auth status` to detect authenticated platforms Ã¢â‚¬â€ no manual config needed.
...
- **One decision per question Ã¢â‚¬â€ everywhere.** Every skill now presents decisions one at a time, each with its own focused question, recommendation, and options. No more wall-of-text questions that bundle unrelated choices together. This was already enforced in the three plan-review skills; now it's a universal rule across all 23+ skills.

## [0.11.18.0] - 2026-03-24 Ã¢â‚¬â€ Ship With Teeth
...
- **Plan-aware scope drift detection.** /review's scope drift check now reads the plan file too Ã¢â‚¬â€ not just TODOS.md and PR description.
- **Auto-verification via /qa-only.** /ship reads your plan's verification section and runs /qa-only inline to test it Ã¢â‚¬â€ if a dev server is running on localhost. No server, no problem Ã¢â‚¬â€ it skips gracefully.
...
## [0.11.17.0] - 2026-03-24 Ã¢â‚¬â€ Cleaner Skill Descriptions + Proactive Opt-Out
...
- **You can now opt out of proactive skill suggestions.** The first time you run any gstack skill, you'll be asked whether you want gstack to suggest skills during your workflow. If you prefer to invoke skills manually, just say no Ã¢â‚¬â€ it's saved as a global setting. You can change your mind anytime with `gstack-config set proactive true/false`.
...
- **Cursor advancement is now safe.** The sync script checks the edge function's `inserted` count before advancing Ã¢â‚¬â€ if zero events were inserted, the cursor holds and retries next run.
...
- `E2E_TIERS` map in `test/helpers/touchfiles.ts` classifies every test Ã¢â‚¬â€ a free validation test ensures it stays in sync with `E2E_TOUCHFILES`
...
## [0.11.15.0] - 2026-03-24 Ã¢â‚¬â€ E2E Test Coverage for Plan Reviews & Codex

### Added

- **E2E tests verify plan review reports appear at the bottom of plans.** The `/plan-eng-review` review report is now tested end-to-end Ã¢â‚¬â€ if it stops writing `## GSTACK REVIEW REPORT` to the plan file, the test catches it.
...
## [0.11.14.0] - 2026-03-24 Ã¢â‚¬â€ Windows Browse Fix

### Fixed

- **Browse engine now works on Windows.** Three compounding bugs blocked all Windows `/browse` users: the server process died when the CLI exited (Bun's `unref()` doesn't truly detach on Windows), the health check never ran because `process.kill(pid, 0)` is broken in Bun binaries on Windows, and Chromium's sandbox failed when spawned through the BunÃ¢â€ â€™Node process chain. All three are now fixed. Credits to @fqueiro (PR #191) for identifying the `detached: true` approach.
- **Health check runs first on all platforms.** `ensureServer()` now tries an HTTP health check before falling back to PID-based detection Ã¢â‚¬â€ more reliable on every OS, not just Windows.
...
- **Chromium sandbox disabled on Windows.** Chromium's sandbox requires elevated privileges when spawned through the BunÃ¢â€ â€™Node chain Ã¢â‚¬â€ now disabled on Windows only.

### For contributors

- New tests for `isServerHealthy()` and startup error logging in `browse/test/config.test.ts`

## [0.11.13.0] - 2026-03-24 Ã¢â‚¬â€ Worktree Isolation + Infrastructure Elegance
...
- **Harvest deduplication.** If a test keeps producing the same improvement across runs, it's detected via SHA-256 hash and skipped Ã¢â‚¬â€ no duplicate patches piling up.
...
- WorktreeManager (`lib/worktree.ts`) is a reusable platform module Ã¢â‚¬â€ future skills like `/batch` can import it directly.
...
## [0.11.12.0] - 2026-03-24 Ã¢â‚¬â€ Triple-Voice Autoplan

Every `/autoplan` phase now gets two independent second opinions Ã¢â‚¬â€ one from Codex (OpenAI's frontier model) and one from a fresh Claude subagent. Three AI reviewers looking at your plan from different angles, each phase building on the last.

### Added

- **Dual voices in every autoplan phase.** CEO review, Design review, and Eng review each run both a Codex challenge and an independent Claude subagent simultaneously. You get a consensus table showing where the models agree and disagree Ã¢â‚¬â€ disagreements surface as taste decisions at the final gate.
...
- **Cross-phase synthesis.** Phase 4 gate highlights themes that appeared independently in multiple phases Ã¢â‚¬â€ high-confidence signals when different reviewers catch the same issue.
...
## [0.11.11.0] - 2026-03-23 Ã¢â‚¬â€ Community Wave 3

10 community PRs merged Ã¢â‚¬â€ bug fixes, platform support, and workflow improvements.
...
## [0.11.10.0] - 2026-03-23 Ã¢â‚¬â€ CI Evals on Ubicloud
...
- **3x faster eval runs.** All E2E tests run concurrently within files via `testConcurrentIfSelected`. Wall clock drops from ~18min to ~6min Ã¢â‚¬â€ limited by the slowest individual test, not sequential sum.
...
- **Routing tests now work in CI.** Skills are installed at top-level `.claude/skills/` instead of nested under `.claude/skills/gstack/` Ã¢â‚¬â€ project-level skill discovery doesn't recurse into subdirectories.
...
## [0.11.9.0] - 2026-03-23 Ã¢â‚¬â€ Codex Skill Loading Fix
...
- **Codex E2E tests now assert no skill loading errors.** The exact "Skipped loading skill(s)" error that prompted this fix is now a regression test Ã¢â‚¬â€ `stderr` is captured and checked.
...
- P1 TODO added: CodexÃ¢â€ â€™Claude reverse buddy check skill

## [0.11.8.0] - 2026-03-23 Ã¢â‚¬â€ zsh Compatibility Fix
...
## [0.11.7.0] - 2026-03-23 Ã¢â‚¬â€ /review Ã¢â€ â€™ /ship Handoff Fix
...
## [0.11.6.0] - 2026-03-23 Ã¢â‚¬â€ Infrastructure-First Security Audit

### Added

- **`/cso` v2 Ã¢â‚¬â€ start where the breaches actually happen.** The security audit now begins with your infrastructure attack surface (leaked secrets in git history, dependency CVEs, CI/CD pipeline misconfigurations, unverified webhooks, Dockerfile security) before touching application code. 15 phases covering secrets archaeology, supply chain, CI/CD, LLM/AI security, skill supply chain, OWASP Top 10, STRIDE, and active verification.
...
- **Active verification.** Every finding gets independently verified by a subagent before reporting Ã¢â‚¬â€ no more grep-and-guess. Variant analysis: when one vulnerability is confirmed, the entire codebase is searched for the same pattern.
...
- **Diff-scoped auditing.** `--diff` mode scopes the audit to changes on your branch vs the base branch Ã¢â‚¬â€ perfect for pre-merge security checks.
...
## [0.11.5.1] - 2026-03-23 Ã¢â‚¬â€ Inline Office Hours
...
## [0.11.5.0] - 2026-03-23 Ã¢â‚¬â€ Bash Compatibility Fix
...
## [0.11.4.0] - 2026-03-22 Ã¢â‚¬â€ Codex in Office Hours

### Added

- **Your brainstorming now gets a second opinion.** After premise challenge in `/office-hours`, you can opt in to a Codex cold read Ã¢â‚¬â€ a completely independent AI that hasn't seen the conversation reviews your problem, answers, and premises. It steelmans your idea, identifies the most revealing thing you said, challenges one premise, and proposes a 48-hour prototype. Two different AI models seeing different things catches blind spots neither would find alone.
- **Cross-Model Perspective in design docs.** When you use the second opinion, the design doc automatically includes a `## Cross-Model Perspective` section capturing what Codex said Ã¢â‚¬â€ so the independent view is preserved for downstream reviews.
...
## [0.11.3.0] - 2026-03-23 Ã¢â‚¬â€ Design Outside Voices

### Added

- **Every design review now gets a second opinion.** `/plan-design-review`, `/design-review`, and `/design-consultation` dispatch both Codex (OpenAI) and a fresh Claude subagent in parallel to independently evaluate your design Ã¢â‚¬â€ then synthesize findings with a litmus scorecard showing where they agree and disagree. Cross-model agreement = high confidence; disagreement = investigate.
- **OpenAI's design hard rules baked in.** 7 hard rejection criteria, 7 litmus checks, and a landing-page vs app-UI classifier from OpenAI's "Designing Delightful Frontends" framework Ã¢â‚¬â€ merged with gstack's existing 10-item AI slop blacklist. Your design gets evaluated against the same rules OpenAI recommends for their own models.
- **Codex design voice in every PR.** The lightweight design review that runs in `/ship` and `/review` now includes a Codex design check when frontend files change Ã¢â‚¬â€ automatic, no opt-in needed.
...
## [0.11.2.0] - 2026-03-22 Ã¢â‚¬â€ Codex Just Works

### Fixed

- **Codex no longer shows "exceeds maximum length of 1024 characters" on startup.** Skill descriptions compressed from ~1,200 words to ~280 words Ã¢â‚¬â€ well under the limit. Every skill now has a test enforcing the cap.
- **No more duplicate skill discovery.** Codex used to find both source SKILL.md files and generated Codex skills, showing every skill twice. Setup now creates a minimal runtime root at `~/.codex/skills/gstack` with only the assets Codex needs Ã¢â‚¬â€ no source files exposed.
...
- **Sidecar directory no longer linked as a skill.** The `.agents/skills/gstack` runtime asset directory was incorrectly symlinked alongside real skills Ã¢â‚¬â€ now skipped.

### Added

- **Repo-local Codex installs.** Clone gstack into `.agents/skills/gstack` inside any repo and run `./setup --host codex` Ã¢â‚¬â€ skills install next to the checkout, no global `~/.codex/` needed. Generated preambles auto-detect whether to use repo-local or global paths at runtime.
...
- **`.agents/` is now gitignored.** Generated Codex skill files are no longer committed Ã¢â‚¬â€ they're created at setup time from templates. Removes 14,000+ lines of generated output from the repo.
...
## [0.11.1.1] - 2026-03-22 Ã¢â‚¬â€ Plan Files Always Show Review Status

### Added

- **Every plan file now shows review status.** When you exit plan mode, the plan file automatically gets a `GSTACK REVIEW REPORT` section Ã¢â‚¬â€ even if you haven't run any formal reviews yet. Previously, this section only appeared after running `/plan-eng-review`, `/plan-ceo-review`, `/plan-design-review`, or `/codex review`. Now you always know where you stand: which reviews have run, which haven't, and what to do next.

## [0.11.1.0] - 2026-03-22 Ã¢â‚¬â€ Global Retro: Cross-Project AI Coding Retrospective

### Added

- **`/retro global` Ã¢â‚¬â€ see everything you shipped across every project in one report.** Scans your Claude Code, Codex CLI, and Gemini CLI sessions, traces each back to its git repo, deduplicates by remote, then runs a full retro across all of them. Global shipping streak, context-switching metrics, per-project breakdowns with personal contributions, and cross-tool usage patterns. Run `/retro global 14d` for a two-week view.
- **Per-project personal contributions in global retro.** Each project in the global retro now shows YOUR commits, LOC, key work, commit type mix, and biggest ship Ã¢â‚¬â€ separate from team totals. Solo projects say "Solo project Ã¢â‚¬â€ all commits are yours." Team projects you didn't touch show session count only.
- **`gstack-global-discover` Ã¢â‚¬â€ the engine behind global retro.** Standalone discovery script that finds all AI coding sessions on your machine, resolves working directories to git repos, normalizes SSH/HTTPS remotes for dedup, and outputs structured JSON. Compiled binary ships with gstack Ã¢â‚¬â€ no `bun` runtime needed.
...
## [0.11.0.0] - 2026-03-22 Ã¢â‚¬â€ /cso: Zero-Noise Security Audits

### Added

- **`/cso` Ã¢â‚¬â€ your Chief Security Officer.** Full codebase security audit: OWASP Top 10, STRIDE threat modeling, attack surface mapping, data classification, and dependency scanning. Each finding includes severity, confidence score, a concrete exploit scenario, and remediation options. Not a linter Ã¢â‚¬â€ a threat model.
...
- **Independent finding verification.** Each candidate finding is verified by a fresh sub-agent that only sees the finding and the false positive rules Ã¢â‚¬â€ no anchoring bias from the initial scan. Findings that fail independent verification are silently dropped.
- **`browse storage` now redacts secrets automatically.** Tokens, JWTs, API keys, GitHub PATs, and Bearer tokens are detected by both key name and value prefix. You see `[REDACTED Ã¢â‚¬â€ 42 chars]` instead of the secret.
...
- **DNS rebinding protection.** `browse goto` now resolves hostnames to IPs and checks against the metadata blocklist Ã¢â‚¬â€ prevents attacks where a domain initially resolves to a safe IP, then switches to a cloud metadata endpoint.
...
## [0.10.2.0] - 2026-03-22 Ã¢â‚¬â€ Autoplan Depth Fix

### Fixed

- **`/autoplan` now produces full-depth reviews instead of compressing everything to one-liners.** When autoplan said "auto-decide," it meant "decide FOR the user using principles" Ã¢â‚¬â€ but the agent interpreted it as "skip the analysis entirely." Now autoplan explicitly defines the contract: auto-decide replaces your judgment, not the analysis. Every review section still gets read, diagrammed, and evaluated. You get the same depth as running each review manually.
- **Execution checklists for CEO and Eng phases.** Each phase now enumerates exactly what must be produced Ã¢â‚¬â€ premise challenges, architecture diagrams, test coverage maps, failure registries, artifacts on disk. No more "follow that file at full depth" without saying what "full depth" means.
...
- **Test review can never be skipped.** The Eng review's test diagram section Ã¢â‚¬â€ the highest-value output Ã¢â‚¬â€ is explicitly marked NEVER SKIP OR COMPRESS with instructions to read actual diffs, map every codepath to coverage, and write the test plan artifact.

## [0.10.1.0] - 2026-03-22 Ã¢â‚¬â€ Test Coverage Catalog

### Added

- **Test coverage audit now works everywhere Ã¢â‚¬â€ plan, ship, and review.** The codepath tracing methodology (ASCII diagrams, quality scoring, gap detection) is shared across `/plan-eng-review`, `/ship`, and `/review` via a single `{{TEST_COVERAGE_AUDIT}}` resolver. Plan mode adds missing tests to your plan before you write code. Ship mode auto-generates tests for gaps. Review mode finds untested paths during pre-landing review. One methodology, three contexts, zero copy-paste.
- **`/review` Step 4.75 Ã¢â‚¬â€ test coverage diagram.** Before landing code, `/review` now traces every changed codepath and produces an ASCII coverage map showing what's tested (Ã¢Ëœâ€¦Ã¢Ëœâ€¦Ã¢Ëœâ€¦/Ã¢Ëœâ€¦Ã¢Ëœâ€¦/Ã¢Ëœâ€¦) and what's not (GAP). Gaps become INFORMATIONAL findings that follow the Fix-First flow Ã¢â‚¬â€ you can generate the missing tests right there.
...
- **Regression detection iron rule.** When a code change modifies existing behavior, gstack always writes a regression test Ã¢â‚¬â€ no asking, no skipping. If you changed it, you test it.
...
- **gstack no longer crashes in repos without an `origin` remote.** The `gstack-repo-mode` helper now gracefully handles missing remotes, bare repos, and empty git output Ã¢â‚¬â€ defaulting to `unknown` mode instead of crashing the preamble.
...
## [0.10.0.0] - 2026-03-22 Ã¢â‚¬â€ Autoplan

### Added

- **`/autoplan` Ã¢â‚¬â€ one command, fully reviewed plan.** Hand it a rough plan and it runs the full CEO Ã¢â€ â€™ design Ã¢â€ â€™ eng review pipeline automatically. Reads the actual review skill files from disk (same depth, same rigor as running each review manually) and makes intermediate decisions using 6 encoded principles: completeness, boil lakes, pragmatic, DRY, explicit over clever, bias toward action. Taste decisions (close approaches, borderline scope, codex disagreements) surface at a final approval gate. You approve, override, interrogate, or revise. Saves a restore point so you can re-run from scratch. Writes review logs compatible with `/ship`'s dashboard.

## [0.9.8.0] - 2026-03-21 Ã¢â‚¬â€ Deploy Pipeline + E2E Performance

### Added

- **`/land-and-deploy` Ã¢â‚¬â€ merge, deploy, and verify in one command.** Takes over where `/ship` left off. Merges the PR, waits for CI and deploy workflows, then runs canary verification on your production URL. Auto-detects your deploy platform (Fly.io, Render, Vercel, Netlify, Heroku, GitHub Actions). Offers revert at every failure point. One command from "PR approved" to "verified in production."
- **`/canary` Ã¢â‚¬â€ post-deploy monitoring loop.** Watches your live app for console errors, performance regressions, and page failures using the browse daemon. Takes periodic screenshots, compares against pre-deploy baselines, and alerts on anomalies. Run `/canary https://myapp.com --duration 10m` after any deploy.
- **`/benchmark` Ã¢â‚¬â€ performance regression detection.** Establishes baselines for page load times, Core Web Vitals, and resource sizes. Compares before/after on every PR. Tracks performance trends over time. Catches the bundle size regressions that code review misses.
- **`/setup-deploy` Ã¢â‚¬â€ one-time deploy configuration.** Detects your deploy platform, production URL, health check endpoints, and deploy status commands. Writes the config to CLAUDE.md so all future `/land-and-deploy` runs are fully automatic.
...
- **`plan-design-review-plan-mode` no longer races.** Each test gets its own isolated tmpdir Ã¢â‚¬â€ no more concurrent tests polluting each other's working directory.
...
- **`design-consultation-core` no longer fails on synonym sections.** "Colors" matches "Color", "Type System" matches "Typography" Ã¢â‚¬â€ fuzzy synonym-based matching with all 7 sections still required.

## [0.9.7.0] - 2026-03-21 Ã¢â‚¬â€ Plan File Review Report

### Added

- **Every plan file now shows which reviews have run.** After any review skill finishes (`/plan-ceo-review`, `/plan-eng-review`, `/plan-design-review`, `/codex review`), a markdown table is appended to the plan file itself Ã¢â‚¬â€ showing each review's trigger command, purpose, run count, status, and findings summary. Anyone reading the plan can see review status at a glance without checking conversation history.
- **Review logs now capture richer data.** CEO reviews log scope proposal counts (proposed/accepted/deferred), eng reviews log total issues found, design reviews log beforeÃ¢â€ â€™after scores, and codex reviews log how many findings were fixed. The plan file report uses these fields directly Ã¢â‚¬â€ no more guessing from partial metadata.

## [0.9.6.0] - 2026-03-21 Ã¢â‚¬â€ Auto-Scaled Adversarial Review

### Changed

- **Review thoroughness now scales automatically with diff size.** Small diffs (<50 lines) skip adversarial review entirely Ã¢â‚¬â€ no wasted time on typo fixes. Medium diffs (50Ã¢â‚¬â€œ199 lines) get a cross-model adversarial challenge from Codex (or a Claude adversarial subagent if Codex isn't installed). Large diffs (200+ lines) get all four passes: Claude structured, Codex structured review with pass/fail gate, Claude adversarial subagent, and Codex adversarial challenge. No configuration needed Ã¢â‚¬â€ it just works.
- **Claude now has an adversarial mode.** A fresh Claude subagent with no checklist bias reviews your code like an attacker Ã¢â‚¬â€ finding edge cases, race conditions, security holes, and silent data corruption that the structured review might miss. Findings are classified as FIXABLE (auto-fixed) or INVESTIGATE (your call).
- **Review dashboard shows "Adversarial" instead of "Codex Review."** The dashboard row reflects the new multi-model reality Ã¢â‚¬â€ it tracks whichever adversarial passes actually ran, not just Codex.

## [0.9.5.0] - 2026-03-21 Ã¢â‚¬â€ Builder Ethos

### Added

- **ETHOS.md Ã¢â‚¬â€ gstack's builder philosophy in one document.** Four principles: The Golden Age (AI compression ratios), Boil the Lake (completeness is cheap), Search Before Building (three layers of knowledge), and Build for Yourself. This is the philosophical source of truth that every workflow skill references.
- **Every workflow skill now searches before recommending.** Before suggesting infrastructure patterns, concurrency approaches, or framework-specific solutions, gstack checks if the runtime has a built-in and whether the pattern is current best practice. Three layers of knowledge Ã¢â‚¬â€ tried-and-true (Layer 1), new-and-popular (Layer 2), and first-principles (Layer 3) Ã¢â‚¬â€ with the most valuable insights prized above all.
...
- **`/office-hours` adds Landscape Awareness phase.** After understanding your problem through questioning but before challenging premises, gstack searches for what the world thinks Ã¢â‚¬â€ then runs a three-layer synthesis to find where conventional wisdom might be wrong for your specific case.
...
- **CEO review saves context when handing off to `/office-hours`.** When `/plan-ceo-review` suggests running `/office-hours` first, it now saves a handoff note with your system audit findings and any discussion so far. When you come back and re-invoke `/plan-ceo-review`, it picks up that context automatically Ã¢â‚¬â€ no more starting from scratch.

## [0.9.4.1] - 2026-03-20

### Changed

- **`/retro` no longer nags about PR size.** The retro still reports PR size distribution (Small/Medium/Large/XL) as neutral data, but no longer flags XL PRs as problems or recommends splitting them. AI reviews don't fatigue Ã¢â‚¬â€ the unit of work is the feature, not the diff.

## [0.9.4.0] - 2026-03-20 Ã¢â‚¬â€ Codex Reviews On By Default

### Changed

- **Codex code reviews now run automatically in `/ship` and `/review`.** No more "want a second opinion?" prompt every time Ã¢â‚¬â€ Codex reviews both your code (with a pass/fail gate) and runs an adversarial challenge by default. First-time users get a one-time opt-in prompt; after that, it's hands-free. Configure with `gstack-config set codex_reviews enabled|disabled`.
- **All Codex operations use maximum reasoning power.** Review, adversarial, and consult modes all use `xhigh` reasoning effort Ã¢â‚¬â€ when an AI is reviewing your code, you want it thinking as hard as possible.
...
- **Codex-for-Codex recursion prevented.** When gstack runs inside Codex CLI (`.agents/skills/`), the Codex review step is completely stripped Ã¢â‚¬â€ no accidental infinite loops.

## [0.9.3.0] - 2026-03-20 Ã¢â‚¬â€ Windows Support
...
- **Node server build script.** `browse/scripts/build-node-server.sh` transpiles the server for Node.js, stubs `bun:sqlite`, and injects the polyfill Ã¢â‚¬â€ all automated during `bun run build`.

## [0.9.2.0] - 2026-03-20 Ã¢â‚¬â€ Gemini CLI E2E Tests
...
## [0.9.1.0] - 2026-03-20 Ã¢â‚¬â€ Adversarial Spec Review + Skill Chaining

### Added

- **Your design docs now get stress-tested before you see them.** When you run `/office-hours`, an independent AI reviewer checks your design doc for completeness, consistency, clarity, scope creep, and feasibility Ã¢â‚¬â€ up to 3 rounds. You get a quality score (1-10) and a summary of what was caught and fixed. The doc you approve has already survived adversarial review.
...
- **Skills help each other now.** `/plan-ceo-review` and `/plan-eng-review` detect when you'd benefit from running `/office-hours` first and offer it Ã¢â‚¬â€ one-tap to switch, one-tap to decline. If you seem lost during a CEO review, it'll gently suggest brainstorming first.
...
- **Review logs and telemetry now persist during plan mode.** When you ran `/plan-ceo-review`, `/plan-eng-review`, or `/plan-design-review` in plan mode, the review result wasn't saved to disk Ã¢â‚¬â€ so the dashboard showed stale or missing entries even though you just completed a review. Same issue affected telemetry logging at the end of every skill. Both now work reliably in plan mode.

## [0.9.0] - 2026-03-19 Ã¢â‚¬â€ Works on Codex, Gemini CLI, and Cursor
...
- **You can now see how you use gstack.** Run `gstack-analytics` to see a personal usage dashboard Ã¢â‚¬â€ which skills you use most, how long they take, your success rate. All data stays local on your machine.
- **Opt-in community telemetry.** On first run, gstack asks if you want to share anonymous usage data (skill names, duration, crash info Ã¢â‚¬â€ never code or file paths). Choose "yes" and you're part of the community pulse. Change anytime with `gstack-config set telemetry off`.
- **Community health dashboard.** Run `gstack-community-dashboard` to see what the gstack community is building Ã¢â‚¬â€ most popular skills, crash clusters, version distribution. All powered by Supabase.
- **Install base tracking via update check.** When telemetry is enabled, gstack fires a parallel ping to Supabase during update checks Ã¢â‚¬â€ giving us an install-base count without adding any latency. Respects your telemetry setting (default off). GitHub remains the primary version source.
...
- **Upgrade funnel tracking.** We can now see how many people see upgrade prompts vs actually upgrade Ã¢â‚¬â€ helps us ship better releases.
...
- **Session-specific pending markers.** If a skill crashes mid-run, the next invocation correctly finalizes only that session Ã¢â‚¬â€ no more race conditions between concurrent gstack sessions.

## [0.8.5] - 2026-03-19

### Fixed

- **`/retro` now counts full calendar days.** Running a retro late at night no longer silently misses commits from earlier in the day. Git treats bare dates like `--since="2026-03-11"` as "11pm on March 11" if you run it at 11pm Ã¢â‚¬â€ now we pass `--since="2026-03-11T00:00:00"` so it always starts from midnight. Compare mode windows get the same fix.
...
- **Platform-agnostic design principle** codified in CLAUDE.md Ã¢â‚¬â€ skills must read project config, never hardcode framework commands.
...
- **`/ship` now automatically syncs your docs.** After creating the PR, `/ship` runs `/document-release` as Step 8.5 Ã¢â‚¬â€ README, ARCHITECTURE, CONTRIBUTING, and CLAUDE.md all stay current without an extra command. No more stale docs after shipping.
...
- **Plan reviews now guide you to the next step.** After running `/plan-ceo-review`, `/plan-eng-review`, or `/plan-design-review`, you get a recommendation for what to run next Ã¢â‚¬â€ eng review is always suggested as the required shipping gate, design review is suggested when UI changes are detected, and CEO review is softly mentioned for big product changes. No more remembering the workflow yourself.
- **Reviews know when they're stale.** Each review now records the commit it was run at. The dashboard compares that against your current HEAD and tells you exactly how many commits have elapsed Ã¢â‚¬â€ "eng review may be stale Ã¢â‚¬â€ 13 commits since review" instead of guessing.
...
- **Auto-handoff hint after 3 consecutive failures.** If the browse tool fails 3 times in a row, it suggests using `handoff` Ã¢â‚¬â€ so you don't waste time watching the AI retry a CAPTCHA.
...
- `recreateContext()` refactored to use shared `saveState()`/`restoreState()` helpers Ã¢â‚¬â€ same behavior, less code, ready for future state persistence features.
...
## [0.8.0] - 2026-03-19 Ã¢â‚¬â€ Multi-AI Second Opinion

**`/codex` Ã¢â‚¬â€ get an independent second opinion from a completely different AI.**

Three modes. `/codex review` runs OpenAI's Codex CLI against your diff and gives a pass/fail gate Ã¢â‚¬â€ if Codex finds critical issues (`[P1]`), it fails. `/codex challenge` goes adversarial: it tries to find ways your code will fail in production, thinking like an attacker and a chaos engineer. `/codex <anything>` opens a conversation with Codex about your codebase, with session continuity so follow-ups remember context.

When both `/review` (Claude) and `/codex review` have run, you get a cross-model analysis showing which findings overlap and which are unique to each AI Ã¢â‚¬â€ building intuition for when to trust which system.
...
**Also in this release:** Proactive skill suggestions Ã¢â‚¬â€ gstack now notices what stage of development you're in and suggests the right skill. Don't like it? Say "stop suggesting" and it remembers across sessions.
...
- **Safety guardrails you can turn on with one command.** Say "be careful" or "safety mode" and `/careful` will warn you before any destructive command Ã¢â‚¬â€ `rm -rf`, `DROP TABLE`, force-push, `kubectl delete`, and more. You can override every warning. Common build artifact cleanups (`rm -rf node_modules`, `dist`, `.next`) are whitelisted.
...
- **`/guard` activates both at once.** One command for maximum safety when touching prod or live systems Ã¢â‚¬â€ destructive command warnings plus directory-scoped edit restrictions.
...
- `/retro` date ranges now align to midnight instead of the current time. Running `/retro` at 9pm no longer silently drops the morning of the start date Ã¢â‚¬â€ you get full calendar days.
...
- **gstack now suggests skills at natural moments.** You don't need to know slash commands Ã¢â‚¬â€ just talk about what you're doing. Brainstorming an idea? gstack suggests `/office-hours`. Something's broken? It suggests `/debug`. Ready to deploy? It suggests `/ship`. Every workflow skill now has proactive triggers that fire when the moment is right.
- **Lifecycle map.** gstack's root skill description now includes a developer workflow guide mapping 12 stages (brainstorm Ã¢â€ â€™ plan Ã¢â€ â€™ review Ã¢â€ â€™ code Ã¢â€ â€™ debug Ã¢â€ â€™ test Ã¢â€ â€™ ship Ã¢â€ â€™ docs Ã¢â€ â€™ retro) to the right skill. Claude sees this in every session.
- **Opt-out with natural language.** If proactive suggestions feel too aggressive, just say "stop suggesting things" Ã¢â‚¬â€ gstack remembers across sessions. Say "be proactive again" to re-enable.
...
- **Trigger phrase validation.** Static tests verify every workflow skill has "Use when" and "Proactively suggest" phrases Ã¢â‚¬â€ catches regressions for free.

### Fixed

- `/debug` and `/office-hours` were completely invisible to natural language Ã¢â‚¬â€ no trigger phrases at all. Now both have full reactive + proactive triggers.

## [0.7.0] - 2026-03-18 Ã¢â‚¬â€ YC Office Hours

**`/office-hours` Ã¢â‚¬â€ sit down with a YC partner before you write a line of code.**
...
Both modes write a design doc that feeds directly into `/plan-ceo-review` and `/plan-eng-review`. After the session, the skill reflects back what it noticed about how you think Ã¢â‚¬â€ specific observations, not generic praise.

**`/debug` Ã¢â‚¬â€ find the root cause, not the symptom.**
...
- **Skills now discoverable via natural language.** All 12 skills that were missing explicit trigger phrases now have them Ã¢â‚¬â€ say "deploy this" and Claude finds `/ship`, say "check my diff" and it finds `/review`. Following Anthropic's best practice: "the description field is not a summary Ã¢â‚¬â€ it's when to trigger."

## [0.6.4.0] - 2026-03-17

### Added

- **`/plan-design-review` is now interactive Ã¢â‚¬â€ rates 0-10, fixes the plan.** Instead of producing a report with letter grades, the designer now works like CEO and Eng review: rates each design dimension 0-10, explains what a 10 looks like, then edits the plan to get there. One AskUserQuestion per design choice. The output is a better plan, not a document about the plan.
...
- **Bisect commit style.** CLAUDE.md now requires every commit to be a single logical change Ã¢â‚¬â€ renames separate from rewrites, test infrastructure separate from test implementations.

### Changed

- `/qa-design-review` renamed to `/design-review` Ã¢â‚¬â€ the "qa-" prefix was confusing now that `/plan-design-review` is plan-mode. Updated across all 22 files.
...
- **Latent space activation, not checklists.** The cognitive patterns name-drop frameworks and people so the LLM draws on its deep knowledge of how they actually think. The instruction is "internalize these, don't enumerate them" Ã¢â‚¬â€ making each review a genuine perspective shift, not a longer checklist.
...
- **Completeness guardrail catches forgotten test entries.** A free unit test validates that every `testName` in the E2E and LLM-judge test files has a corresponding entry in the TOUCHFILES map. New tests without entries fail `bun test` immediately Ã¢â‚¬â€ no silent always-run degradation.
...
## 0.6.1 Ã¢â‚¬â€ 2026-03-17 Ã¢â‚¬â€ Boil the Lake
...
## 0.6.0.1 Ã¢â‚¬â€ 2026-03-17

- **`/gstack-upgrade` now catches stale vendored copies automatically.** If your global gstack is up to date but the vendored copy in your project is behind, `/gstack-upgrade` detects the mismatch and syncs it. No more manually asking "did we vendor it?" Ã¢â‚¬â€ it just tells you and offers to update.
...
- Update check fallback in standalone mode now matches the preamble pattern (global path Ã¢â€ â€™ local path Ã¢â€ â€™ `|| true`).

## 0.6.0 Ã¢â‚¬â€ 2026-03-17
...
- **Ship with confidence Ã¢â‚¬â€ coverage audit shows what's tested and what's not.** `/ship` Step 3.4 builds a code path map from your diff, searches for corresponding tests, and produces an ASCII coverage diagram with quality stars (Ã¢Ëœâ€¦Ã¢Ëœâ€¦Ã¢Ëœâ€¦ = edge cases + errors, Ã¢Ëœâ€¦Ã¢Ëœâ€¦ = happy path, Ã¢Ëœâ€¦ = smoke test). Gaps get tests auto-generated. PR body shows "Tests: 42 Ã¢â€ â€™ 47 (+5 new)".
...
- Added review gate override persistence to `ship/SKILL.md.tmpl` Ã¢â‚¬â€ writes `ship-review-override` entries to `$BRANCH-reviews.jsonl` so subsequent `/ship` runs skip the gate.
- Updated 2 E2E test prompts to match new flow.

## 0.5.3 Ã¢â‚¬â€ 2026-03-17

- **You're always in control Ã¢â‚¬â€ even when dreaming big.** `/plan-ceo-review` now presents every scope expansion as an individual decision you opt into. EXPANSION mode recommends enthusiastically, but you say yes or no to each idea. No more "the agent went wild and added 5 features I didn't ask for."
- **New mode: SELECTIVE EXPANSION.** Hold your current scope as the baseline, but see what else is possible. The agent surfaces expansion opportunities one by one with neutral recommendations Ã¢â‚¬â€ you cherry-pick the ones worth doing. Perfect for iterating on existing features where you want rigor but also want to be tempted by adjacent improvements.
...
- Rewrote EXPANSION mode's Step 0D to include opt-in ceremony Ã¢â‚¬â€ distill vision into discrete proposals, present each as AskUserQuestion.
...
## 0.5.2 Ã¢â‚¬â€ 2026-03-17

- **Your design consultant now takes creative risks.** `/design-consultation` doesn't just propose a safe, coherent system Ã¢â‚¬â€ it explicitly breaks down SAFE CHOICES (category baseline) vs. RISKS (where your product stands out). You pick which rules to break. Every risk comes with a rationale for why it works and what it costs.
- **See the landscape before you choose.** When you opt into research, the agent browses real sites in your space with screenshots and accessibility tree analysis Ã¢â‚¬â€ not just web search results. You see what's out there before making design decisions.
- **Preview pages that look like your product.** The preview page now renders realistic product mockups Ã¢â‚¬â€ dashboards with sidebar nav and data tables, marketing pages with hero sections, settings pages with forms Ã¢â‚¬â€ not just font swatches and color palettes.

## 0.5.1 Ã¢â‚¬â€ 2026-03-17
- **Know where you stand before you ship.** Every `/plan-ceo-review`, `/plan-eng-review`, and `/plan-design-review` now logs its result to a review tracker. At the end of each review, you see a **Review Readiness Dashboard** showing which reviews are done, when they ran, and whether they're clean Ã¢â‚¬â€ with a clear CLEARED TO SHIP or NOT READY verdict.
- **`/ship` checks your reviews before creating the PR.** Pre-flight now reads the dashboard and asks if you want to continue when reviews are missing. Informational only Ã¢â‚¬â€ it won't block you, but you'll know what you skipped.
...
- **Screenshots are now visible during QA and browse sessions.** When gstack takes screenshots, they now show up as clickable image elements in your output Ã¢â‚¬â€ no more invisible `/tmp/browse-screenshot.png` paths you can't see. Works in `/qa`, `/qa-only`, `/plan-design-review`, `/qa-design-review`, `/browse`, and `/gstack`.

### For contributors

- Added `{{REVIEW_DASHBOARD}}` resolver to `gen-skill-docs.ts` Ã¢â‚¬â€ shared dashboard reader injected into 4 templates (3 review skills + ship).
...
## 0.5.0 Ã¢â‚¬â€ 2026-03-16

- **Your site just got a design review.** `/plan-design-review` opens your site and reviews it like a senior product designer Ã¢â‚¬â€ typography, spacing, hierarchy, color, responsive, interactions, and AI slop detection. Get letter grades (A-F) per category, a dual headline "Design Score" + "AI Slop Score", and a structured first impression that doesn't pull punches.
...
- **Know your actual design system.** Both skills extract your live site's fonts, colors, heading scale, and spacing patterns via JS Ã¢â‚¬â€ then offer to save the inferred system as a `DESIGN.md` baseline. Finally know how many fonts you're actually using.
- **AI Slop detection is a headline metric.** Every report opens with two scores: Design Score and AI Slop Score. The AI slop checklist catches the 10 most recognizable AI-generated patterns Ã¢â‚¬â€ the 3-column feature grid, purple gradients, decorative blobs, emoji bullets, generic hero copy.
...
- Added `{{DESIGN_METHODOLOGY}}` resolver to `gen-skill-docs.ts` Ã¢â‚¬â€ shared design audit methodology injected into both `/plan-design-review` and `/qa-design-review` templates, following the `{{QA_METHODOLOGY}}` pattern.
...
## 0.4.5 Ã¢â‚¬â€ 2026-03-16

- **Review findings now actually get fixed, not just listed.** `/review` and `/ship` used to print informational findings (dead code, test gaps, N+1 queries) and then ignore them. Now every finding gets action: obvious mechanical fixes are applied automatically, and genuinely ambiguous issues are batched into a single question instead of 8 separate prompts. You see `[AUTO-FIXED] file:line Problem Ã¢â€ â€™ what was done` for each auto-fix.
...
- **`$B js "const x = await fetch(...); return x.status"` now works.** The `js` command used to wrap everything as an expression Ã¢â‚¬â€ so `const`, semicolons, and multi-line code all broke. It now detects statements and uses a block wrapper, just like `eval` already did.
...
- Gate Classification Ã¢â€ â€™ Severity Classification rename (severity determines presentation order, not whether you see a prompt).
- Fix-First Heuristic section added to `review/checklist.md` Ã¢â‚¬â€ the canonical AUTO-FIX vs ASK classification.
- New validation test: `Fix-First Heuristic exists in checklist and is referenced by review + ship`.
- Extracted `needsBlockWrapper()` and `wrapForEvaluate()` helpers in `read-commands.ts` Ã¢â‚¬â€ shared by both `js` and `eval` commands (DRY).
- Added `getRefRole()` to `BrowserManager` Ã¢â‚¬â€ exposes ARIA role for ref selectors without changing `resolveRef` return type.
...
## 0.4.3 Ã¢â‚¬â€ 2026-03-16

- **New `/document-release` skill.** Run it after `/ship` but before merging Ã¢â‚¬â€ it reads every doc file in your project, cross-references the diff, and updates README, ARCHITECTURE, CONTRIBUTING, CHANGELOG, and TODOS to match what you actually shipped. Risky changes get surfaced as questions; everything else is automatic.
- **Every question is now crystal clear, every time.** You used to need 3+ sessions running before gstack would give you full context and plain English explanations. Now every question Ã¢â‚¬â€ even in a single session Ã¢â‚¬â€ tells you the project, branch, and what's happening, explained simply enough to understand mid-context-switch. No more "sorry, explain it to me more simply."
...
- Merged ELI16 rules into base AskUserQuestion format Ã¢â‚¬â€ one format instead of two, no `_SESSIONS >= 3` conditional.
...
- **`/retro` works on any default branch.** Repos using `master`, `develop`, or other default branch names are detected automatically Ã¢â‚¬â€ no more empty retros because the branch name was wrong.
- **New `{{BASE_BRANCH_DETECT}}` placeholder** for skill authors Ã¢â‚¬â€ drop it into any template and get 3-step branch detection (PR base Ã¢â€ â€™ repo default Ã¢â€ â€™ fallback) for free.
...
- Smart eval wrapping: single-line Ã¢â€ â€™ expression `(...)`, multi-line Ã¢â€ â€™ block `{...}` with explicit `return`.
...
- Added "Writing SKILL templates" section to CLAUDE.md Ã¢â‚¬â€ rules for natural language over bash-isms, dynamic branch detection, self-contained code blocks.
...
## 0.4.1 Ã¢â‚¬â€ 2026-03-16

- **gstack now notices when it screws up.** Turn on contributor mode (`gstack-config set gstack_contributor true`) and gstack automatically writes up what went wrong Ã¢â‚¬â€ what you were doing, what broke, repro steps. Next time something annoys you, the bug report is already written. Fork gstack and fix it yourself.
...
- **/review now catches forgotten enum handlers.** Add a new status, tier, or type constant? /review traces it through every switch statement, allowlist, and filter in your codebase Ã¢â‚¬â€ not just the files you changed. Catches the "added the value but forgot to handle it" class of bugs before they ship.

### For contributors

- Renamed `{{UPDATE_CHECK}}` to `{{PREAMBLE}}` across all 11 skill templates Ã¢â‚¬â€ one startup block now handles update check, session tracking, contributor mode, and question formatting.
...
## 0.4.0 Ã¢â‚¬â€ 2026-03-16

### Added
- **QA-only skill** (`/qa-only`) Ã¢â‚¬â€ report-only QA mode that finds and documents bugs without making fixes. Hand off a clean bug report to your team without the agent touching your code.
- **QA fix loop** Ã¢â‚¬â€ `/qa` now runs a find-fix-verify cycle: discover bugs, fix them, commit, re-navigate to confirm the fix took. One command to go from broken to shipped.
- **Plan-to-QA artifact flow** Ã¢â‚¬â€ `/plan-eng-review` writes test-plan artifacts that `/qa` picks up automatically. Your engineering review now feeds directly into QA testing with no manual copy-paste.
- **`{{QA_METHODOLOGY}}` DRY placeholder** Ã¢â‚¬â€ shared QA methodology block injected into both `/qa` and `/qa-only` templates. Keeps both skills in sync when you update testing standards.
- **Eval efficiency metrics** Ã¢â‚¬â€ turns, duration, and cost now displayed across all eval surfaces with natural-language **Takeaway** commentary. See at a glance whether your prompt changes made the agent faster or slower.
- **`generateCommentary()` engine** Ã¢â‚¬â€ interprets comparison deltas so you don't have to: flags regressions, notes improvements, and produces an overall efficiency summary.
- **Eval list columns** Ã¢â‚¬â€ `bun run eval:list` now shows Turns and Duration per run. Spot expensive or slow runs instantly.
- **Eval summary per-test efficiency** Ã¢â‚¬â€ `bun run eval:summary` shows average turns/duration/cost per test across runs. Identify which tests are costing you the most over time.
- **`judgePassed()` unit tests** Ã¢â‚¬â€ extracted and tested the pass/fail judgment logic.
- **3 new E2E tests** Ã¢â‚¬â€ qa-only no-fix guardrail, qa fix loop with commit verification, plan-eng-review test-plan artifact.
- **Browser ref staleness detection** Ã¢â‚¬â€ `resolveRef()` now checks element count to detect stale refs after page mutations. SPA navigation no longer causes 30-second timeouts on missing elements.
- 3 new snapshot tests for ref staleness.

### Changed
- QA skill prompt restructured with explicit two-cycle workflow (find Ã¢â€ â€™ fix Ã¢â€ â€™ verify).
...
### Fixed
- Browser ref staleness Ã¢â‚¬â€ refs collected before page mutation (e.g. SPA navigation) are now detected and re-collected. Eliminates a class of flaky QA failures on dynamic sites.

## 0.3.9 Ã¢â‚¬â€ 2026-03-15

### Added
- **`bin/gstack-config` CLI** Ã¢â‚¬â€ simple get/set/list interface for `~/.gstack/config.yaml`. Used by update-check and upgrade skill for persistent settings (auto_upgrade, update_check).
- **Smart update check** Ã¢â‚¬â€ 12h cache TTL (was 24h), exponential snooze backoff (24h Ã¢â€ â€™ 48h Ã¢â€ â€™ 1 week) when user declines upgrades, `update_check: false` config option to disable checks entirely. Snooze resets when a new version is released.
- **Auto-upgrade mode** Ã¢â‚¬â€ set `auto_upgrade: true` in config or `GSTACK_AUTO_UPGRADE=1` env var to skip the upgrade prompt and update automatically.
- **4-option upgrade prompt** Ã¢â‚¬â€ "Yes, upgrade now", "Always keep me up to date", "Not now" (snooze), "Never ask again" (disable).
- **Vendored copy sync** Ã¢â‚¬â€ `/gstack-upgrade` now detects and updates local vendored copies in the current project after upgrading the primary install.
...
## 0.3.8 Ã¢â‚¬â€ 2026-03-14

### Added
- **TODOS.md as single source of truth** Ã¢â‚¬â€ merged `TODO.md` (roadmap) and `TODOS.md` (near-term) into one file organized by skill/component with P0-P4 priority ordering and a Completed section.
- **`/ship` Step 5.5: TODOS.md management** Ã¢â‚¬â€ auto-detects completed items from the diff, marks them done with version annotations, offers to create/reorganize TODOS.md if missing or unstructured.
- **Cross-skill TODOS awareness** Ã¢â‚¬â€ `/plan-ceo-review`, `/plan-eng-review`, `/retro`, `/review`, and `/qa` now read TODOS.md for project context. `/retro` adds Backlog Health metric (open counts, P0/P1 items, churn).
- **Shared `review/TODOS-format.md`** Ã¢â‚¬â€ canonical TODO item format referenced by `/ship` and `/plan-ceo-review` to prevent format drift (DRY).
- **Greptile 2-tier reply system** Ã¢â‚¬â€ Tier 1 (friendly, inline diff + explanation) for first responses; Tier 2 (firm, full evidence chain + re-rank request) when Greptile re-flags after a prior reply.
- **Greptile reply templates** Ã¢â‚¬â€ structured templates in `greptile-triage.md` for fixes (inline diff), already-fixed (what was done), and false positives (evidence + suggested re-rank). Replaces vague one-line replies.
- **Greptile escalation detection** Ã¢â‚¬â€ explicit algorithm to detect prior GStack replies on comment threads and auto-escalate to Tier 2.
- **Greptile severity re-ranking** Ã¢â‚¬â€ replies now include `**Suggested re-rank:**` when Greptile miscategorizes issue severity.
- Static validation tests for `TODOS-format.md` references across skills.

### Fixed
- **`.gitignore` append failures silently swallowed** Ã¢â‚¬â€ `ensureStateDir()` bare `catch {}` replaced with ENOENT-only silence; non-ENOENT errors (EACCES, ENOSPC) logged to `.gstack/browse-server.log`.

### Changed
- `TODO.md` deleted Ã¢â‚¬â€ all items merged into `TODOS.md`.
...
## 0.3.6 Ã¢â‚¬â€ 2026-03-14

### Added
- **E2E observability** Ã¢â‚¬â€ heartbeat file (`~/.gstack-dev/e2e-live.json`), per-run log directory (`~/.gstack-dev/e2e-runs/{runId}/`), progress.log, per-test NDJSON transcripts, persistent failure transcripts. All I/O non-fatal.
- **`bun run eval:watch`** Ã¢â‚¬â€ live terminal dashboard reads heartbeat + partial eval file every 1s. Shows completed tests, current test with turn/tool info, stale detection (>10min), `--tail` for progress.log.
- **Incremental eval saves** Ã¢â‚¬â€ `savePartial()` writes `_partial-e2e.json` after each test completes. Crash-resilient: partial results survive killed runs. Never cleaned up.
- **Machine-readable diagnostics** Ã¢â‚¬â€ `exit_reason`, `timeout_at_turn`, `last_tool_call` fields in eval JSON. Enables `jq` queries for automated fix loops.
- **API connectivity pre-check** Ã¢â‚¬â€ E2E suite throws immediately on ConnectionRefused before burning test budget.
- **`is_error` detection** Ã¢â‚¬â€ `claude -p` can return `subtype: "success"` with `is_error: true` on API failures. Now correctly classified as `error_api`.
- **Stream-json NDJSON parser** Ã¢â‚¬â€ `parseNDJSON()` pure function for real-time E2E progress from `claude -p --output-format stream-json --verbose`.
- **Eval persistence** Ã¢â‚¬â€ results saved to `~/.gstack-dev/evals/` with auto-comparison against previous run.
- **Eval CLI tools** Ã¢â‚¬â€ `eval:list`, `eval:compare`, `eval:summary` for inspecting eval history.
- **All 9 skills converted to `.tmpl` templates** Ã¢â‚¬â€ plan-ceo-review, plan-eng-review, retro, review, ship now use `{{UPDATE_CHECK}}` placeholder. Single source of truth for update check preamble.
- **3-tier eval suite** Ã¢â‚¬â€ Tier 1: static validation (free), Tier 2: E2E via `claude -p` (~$3.85/run), Tier 3: LLM-as-judge (~$0.15/run). Gated by `EVALS=1`.
- **Planted-bug outcome testing** Ã¢â‚¬â€ eval fixtures with known bugs, LLM judge scores detection.
...
- `test/helpers/skill-parser.ts` Ã¢â‚¬â€ `getRemoteSlug()` for git remote detection.

### Fixed
- **Browse binary discovery broken for agents** Ã¢â‚¬â€ replaced `find-browse` indirection with explicit `browse/dist/browse` path in SKILL.md setup blocks.
- **Update check exit code 1 misleading agents** Ã¢â‚¬â€ added `|| true` to prevent non-zero exit when no update available.
- **browse/SKILL.md missing setup block** Ã¢â‚¬â€ added `{{BROWSE_SETUP}}` placeholder.
- **plan-ceo-review timeout** Ã¢â‚¬â€ init git repo in test dir, skip codebase exploration, bump timeout to 420s.
- Planted-bug eval reliability Ã¢â‚¬â€ simplified prompts, lowered detection baselines, resilient to max_turns flakes.

### Changed
- **Template system expanded** Ã¢â‚¬â€ `{{UPDATE_CHECK}}` and `{{BROWSE_SETUP}}` placeholders in `gen-skill-docs.ts`. All browse-using skills generate from single source of truth.
...
## 0.3.3 Ã¢â‚¬â€ 2026-03-13

### Added
- **SKILL.md template system** Ã¢â‚¬â€ `.tmpl` files with `{{COMMAND_REFERENCE}}` and `{{SNAPSHOT_FLAGS}}` placeholders, auto-generated from source code at build time. Structurally prevents command drift between docs and code.
- **Command registry** (`browse/src/commands.ts`) Ã¢â‚¬â€ single source of truth for all browse commands with categories and enriched descriptions. Zero side effects, safe to import from build scripts and tests.
- **Snapshot flags metadata** (`SNAPSHOT_FLAGS` array in `browse/src/snapshot.ts`) Ã¢â‚¬â€ metadata-driven parser replaces hand-coded switch/case. Adding a flag in one place updates the parser, docs, and tests.
- **Tier 1 static validation** Ã¢â‚¬â€ 43 tests: parses `$B` commands from SKILL.md code blocks, validates against command registry and snapshot flag metadata
- **Tier 2 E2E tests** via Agent SDK Ã¢â‚¬â€ spawns real Claude sessions, runs skills, scans for browse errors. Gated by `SKILL_E2E=1` env var (~$0.50/run)
- **Tier 3 LLM-as-judge evals** Ã¢â‚¬â€ Haiku scores generated docs on clarity/completeness/actionability (threshold Ã¢â€°Â¥4/5), plus regression test vs hand-maintained baseline. Gated by `ANTHROPIC_API_KEY`
- **`bun run skill:check`** Ã¢â‚¬â€ health dashboard showing all skills, command counts, validation status, template freshness
- **`bun run dev:skill`** Ã¢â‚¬â€ watch mode that regenerates and validates SKILL.md on every template or source file change
- **CI workflow** (`.github/workflows/skill-docs.yml`) Ã¢â‚¬â€ runs `gen:skill-docs` on push/PR, fails if generated output differs from committed files
- `bun run gen:skill-docs` script for manual regeneration
- `bun run test:eval` for LLM-as-judge evals
- `test/helpers/skill-parser.ts` Ã¢â‚¬â€ extracts and validates `$B` commands from Markdown
- `test/helpers/session-runner.ts` Ã¢â‚¬â€ Agent SDK wrapper with error pattern scanning and transcript saving
- **ARCHITECTURE.md** Ã¢â‚¬â€ design decisions document covering daemon model, security, ref system, logging, crash recovery
- **Conductor integration** (`conductor.json`) Ã¢â‚¬â€ lifecycle hooks for workspace setup/teardown
- **`.env` propagation** Ã¢â‚¬â€ `bin/dev-setup` copies `.env` from main worktree into Conductor workspaces automatically
...
## 0.3.2 Ã¢â‚¬â€ 2026-03-13

### Fixed
- Cookie import picker now returns JSON instead of HTML Ã¢â‚¬â€ `jsonResponse()` referenced `url` out of scope, crashing every API call
- `help` command routed correctly (was unreachable due to META_COMMANDS dispatch ordering)
- Stale servers from global install no longer shadow local changes Ã¢â‚¬â€ removed legacy `~/.claude/skills/gstack` fallback from `resolveServerScript()`
- Crash log path references updated from `/tmp/` to `.gstack/`

### Added
- **Diff-aware QA mode** Ã¢â‚¬â€ `/qa` on a feature branch auto-analyzes `git diff`, identifies affected pages/routes, detects the running app on localhost, and tests only what changed. No URL needed.
- **Project-local browse state** Ã¢â‚¬â€ state file, logs, and all server state now live in `.gstack/` inside the project root (detected via `git rev-parse --show-toplevel`). No more `/tmp` state files.
- **Shared config module** (`browse/src/config.ts`) Ã¢â‚¬â€ centralizes path resolution for CLI and server, eliminates duplicated port/state logic
- **Random port selection** Ã¢â‚¬â€ server picks a random port 10000-60000 instead of scanning 9400-9409. No more CONDUCTOR_PORT magic offset. No more port collisions across workspaces.
- **Binary version tracking** Ã¢â‚¬â€ state file includes `binaryVersion` SHA; CLI auto-restarts the server when the binary is rebuilt
- **Legacy /tmp cleanup** Ã¢â‚¬â€ CLI scans for and removes old `/tmp/browse-server*.json` files, verifying PID ownership before sending signals
- **Greptile integration** Ã¢â‚¬â€ `/review` and `/ship` fetch and triage Greptile bot comments; `/retro` tracks Greptile batting average across weeks
- **Local dev mode** Ã¢â‚¬â€ `bin/dev-setup` symlinks skills from the repo for in-place development; `bin/dev-teardown` restores global install
- `help` command Ã¢â‚¬â€ agents can self-discover all commands and snapshot flags
- Version-aware `find-browse` with META signal protocol Ã¢â‚¬â€ detects stale binaries and prompts agents to update
...
- Browser interaction guidance in CLAUDE.md Ã¢â‚¬â€ prevents Claude from using mcp\_\_claude-in-chrome\_\_\* tools
...
- Atomic state file writes: `.json.tmp` Ã¢â€ â€™ rename (prevents partial reads)
...
## 0.3.1 Ã¢â‚¬â€ 2026-03-12

### Phase 3.5: Browser cookie import

- `cookie-import-browser` command Ã¢â‚¬â€ decrypt and import cookies from real Chromium browsers (Comet, Chrome, Arc, Brave, Edge)
...
## 0.3.0 Ã¢â‚¬â€ 2026-03-12

### Phase 3: /qa skill Ã¢â‚¬â€ systematic QA testing
...
- `browse/bin/find-browse` Ã¢â‚¬â€ DRY binary discovery using `git rev-parse --show-toplevel`
...
- Playwright error wrapping Ã¢â‚¬â€ actionable messages for AI agents
...
## 0.0.2 Ã¢â‚¬â€ 2026-03-12

- Fix project-local `/browse` installs Ã¢â‚¬â€ compiled binary now resolves `server.ts` from its own directory instead of assuming a global install exists
