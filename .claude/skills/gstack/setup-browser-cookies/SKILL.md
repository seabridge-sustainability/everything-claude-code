...
```
If `CDP_MODE=true`: tell the user "Not needed Ã¢â‚¬â€ you're connected to your real browser via CDP. Your cookies and sessions are already available." and stop. No cookie import needed.
...
Tell the user: **"Cookie picker opened Ã¢â‚¬â€ select the domains you want to import in your browser, then tell me when you're done."**
...
- On macOS, the first import per browser may trigger a Keychain dialog Ã¢â‚¬â€ click "Allow" / "Always Allow"
...
- Only domain names and cookie counts are shown in the UI Ã¢â‚¬â€ no cookie values are exposed
