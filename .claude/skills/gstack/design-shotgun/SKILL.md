...
"This is /design-shotgun Ã¢â‚¬â€ your visual brainstorming tool. I'll generate multiple AI
...
skill, the calling skill has already gathered context. Check for `$_DESIGN_BRIEF` Ã¢â‚¬â€ if
it's set, skip to Step 2.

When run standalone, gather context to build a proper design brief.

**Required context (5 dimensions):**
1. **Who** Ã¢â‚¬â€ who is the design for? (persona, audience, expertise level)
2. **Job to be done** Ã¢â‚¬â€ what is the user trying to accomplish on this screen/page?
3. **What exists** Ã¢â‚¬â€ what's already in the codebase? (existing components, pages, patterns)
4. **User flow** Ã¢â‚¬â€ how do users arrive at this screen and where do they go next?
5. **Edge cases** Ã¢â‚¬â€ long names, zero results, error states, mobile, first-time vs power user
...
default. If you want to go off the reservation on visual direction, just say so Ã¢â‚¬â€
...
A) "Name" Ã¢â‚¬â€ one-line visual description of this direction
B) "Name" Ã¢â‚¬â€ one-line visual description of this direction
C) "Name" Ã¢â‚¬â€ one-line visual description of this direction
```
...
Options:
- A) Generate all {N} Ã¢â‚¬â€ looks good
...
> A) Iterate more Ã¢â‚¬â€ refine the approved variant with specific feedback
> B) Finalize Ã¢â‚¬â€ generate production Pretext-native HTML/CSS with /design-html
> C) Save to plan Ã¢â‚¬â€ add this as an approved mockup reference in the current plan
> D) Done Ã¢â‚¬â€ I'll use this later"
