...
version: 1.0.0
description: |
  OpenAI Codex CLI wrapper Ã¢â‚¬â€ three modes. Code review: independent diff review via
...
# /codex Ã¢â‚¬â€ Multi-AI Second Opinion

You are running the `/codex` skill. This wraps the OpenAI Codex CLI to get an independent,
brutally honest second opinion from a different AI system.

Codex is the "200 IQ autistic developer" Ã¢â‚¬â€ direct, terse, technically precise, challenges
...
1. `/codex review` or `/codex review <instructions>` Ã¢â‚¬â€ **Review mode** (Step 2A)
2. `/codex challenge` or `/codex challenge <focus>` Ã¢â‚¬â€ **Challenge mode** (Step 2B)
3. `/codex` with no arguments Ã¢â‚¬â€ **Auto-detect:**
   ...
   - If a diff exists, use AskUserQuestion:
     ...
     B) Challenge the diff (adversarial Ã¢â‚¬â€ try to break it)
     C) Something else Ã¢â‚¬â€ I'll provide a prompt
     ```
...
4. `/codex <anything else>` Ã¢â‚¬â€ **Consult mode** (Step 2C), where the remaining text is the prompt
...
- Review (2A): `high` Ã¢â‚¬â€ bounded diff input, needs thoroughness
- Challenge (2B): `high` Ã¢â‚¬â€ adversarial but bounded by diff
- Consult (2C): `medium` Ã¢â‚¬â€ large context, interactive, needs speed
...
4. Determine gate verdict by checking the review output for critical findings.
   If the output contains `[P1]` Ã¢â‚¬â€ the gate is **FAIL**.
   If no `[P1]` markers are found (only `[P2]` or no findings) Ã¢â‚¬â€ the gate is **PASS**.
...
Codex tries to break your code Ã¢â‚¬â€ finding edge cases, race conditions, security holes,
...
Review the changes on this branch against the base branch. Run `git diff origin/<base>` to see the diff. Your job is to find ways this code will fail in production. Think like an attacker and a chaos engineer. Find edge cases, race conditions, security holes, resource leaks, failure modes, and silent data corruption paths. Be adversarial. Be thorough. No compliments Ã¢â‚¬â€ just the problems."
...
```
If no project-scoped match, fall back to `ls -t ~/.claude/plans/*.md 2>/dev/null | head -1`
but warn: "Note: this plan may be from a different project Ã¢â‚¬â€ verify before sending to Codex."

**IMPORTANT Ã¢â‚¬â€ embed content, don't reference path:** Codex runs sandboxed to the repo
...
Codex the file path or ask it to read the plan file Ã¢â‚¬â€ it will waste 10+ tool calls
searching and fail.
...
CODEX SAYS (consult):
Ã¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢Â
<full output, verbatim Ã¢â‚¬â€ includes [codex thinking] traces>
Ã¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢Â
Tokens: N | Est. cost: ~$X.XX
Session saved Ã¢â‚¬â€ run /codex again to continue this conversation.
```
...
**Model:** No model is hardcoded Ã¢â‚¬â€ codex uses whatever its current default is (the frontier
agentic coding model). This means as OpenAI ships newer models, /codex automatically
uses them. If the user wants a specific model, pass `-m` through to codex.

**Reasoning effort (per-mode defaults):**
- **Review (2A):** `high` Ã¢â‚¬â€ bounded diff input, needs thoroughness but not max tokens
- **Challenge (2B):** `high` Ã¢â‚¬â€ adversarial but bounded by diff size
- **Consult (2C):** `medium` Ã¢â‚¬â€ large context (plans, codebase), interactive, needs speed
...
docs and APIs during review. This is OpenAI's cached index Ã¢â‚¬â€ fast, no extra cost.
