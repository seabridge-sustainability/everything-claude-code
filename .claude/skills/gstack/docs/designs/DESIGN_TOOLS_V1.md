...
gstack's design skills (/office-hours, /design-consultation, /plan-design-review, /design-review) all produce **text descriptions** of design Ã¢â‚¬â€ DESIGN.md files with hex codes, plan docs with pixel specs in prose, ASCII art wireframes. The creator is a designer who hand-designed HelloSign in OmniGraffle and finds this embarrassing.

The unit of value is wrong. Users don't need richer design language Ã¢â‚¬â€ they need an executable visual artifact that changes the conversation from "do you like this spec?" to "is this the screen?"

## Problem Statement

Design skills describe design in text instead of showing it. The Argus UX overhaul plan is the example: 487 lines of detailed emotional arc specs, typography choices, animation timing Ã¢â‚¬â€ zero visual artifacts. An AI coding agent that "designs" should produce something you can look at and react to viscerally.

## Demand Evidence

The creator/primary user finds the current output embarrassing. Every design skill session ends with prose where a mockup should be. GPT Image API now generates pixel-perfect UI mockups with accurate text rendering Ã¢â‚¬â€ the capability gap that justified text-only output no longer exists.

## Narrowest Wedge

A compiled TypeScript binary (`design/dist/design`) that wraps the OpenAI Images/Responses API, callable from skill templates via `$D` (mirroring the existing `$B` browse binary pattern). Priority integration order: /office-hours Ã¢â€ â€™ /plan-design-review Ã¢â€ â€™ /design-consultation Ã¢â€ â€™ /design-review.

## Agreed Premises

1. GPT Image API (via OpenAI Responses API) is the right engine. Google Stitch SDK is backup.
2. **Visual mockups are default-on for design skills** with an easy skip path Ã¢â‚¬â€ not opt-in. (Revised per Codex challenge.)
3. The integration is a shared utility (not per-skill reimplementation) Ã¢â‚¬â€ a `design` binary that any skill can call.
...
- Challenged premise #2 (opt-in Ã¢â€ â€™ default-on) Ã¢â‚¬â€ accepted
...
Ã¢â€â€š   Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ cli.ts            # Entry point, command dispatch
Ã¢â€â€š   Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ commands.ts        # Command registry (source of truth for docs + validation)
Ã¢â€â€š   Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ generate.ts        # Generate mockups from structured brief
Ã¢â€â€š   Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ iterate.ts         # Multi-turn iteration on existing mockups
Ã¢â€â€š   Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ variants.ts        # Generate N design variants from brief
Ã¢â€â€š   Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ check.ts           # Vision-based quality gate (GPT-4o)
Ã¢â€â€š   Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ brief.ts           # Structured brief type + assembly helpers
Ã¢â€â€š   Ã¢â€â€Ã¢â€â‚¬Ã¢â€â‚¬ session.ts         # Session state (response IDs for multi-turn)
Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ dist/
Ã¢â€â€š   Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ design             # Compiled binary
Ã¢â€â€š   Ã¢â€â€Ã¢â€â‚¬Ã¢â€â‚¬ .version           # Git hash
Ã¢â€â€Ã¢â€â‚¬Ã¢â€â‚¬ test/
    Ã¢â€â€Ã¢â€â‚¬Ã¢â€â‚¬ design.test.ts     # Integration tests
```
...
**Brief input modes:**
- `--brief "plain text"` Ã¢â‚¬â€ free-form text prompt (simple mode)
- `--brief-file path.json` Ã¢â‚¬â€ structured JSON matching the `DesignBrief` interface (rich mode)
...
1. $D variants --brief "..." --count 3 --output-dir /tmp/mockups/
   Ã¢â€ â€™ Generates 2-5 PNG mockup variations

2. $D compare --images /tmp/mockups/*.png --output /tmp/design-board.html
   Ã¢â€ â€™ Generates HTML comparison board (spec below)

3. $B goto file:///tmp/design-board.html
   Ã¢â€ â€™ User reviews all variants in headed Chrome
...
4. User picks favorite, rates, comments, clicks [Submit]
   ...
   Ã¢â€ â€™ No clipboard, no pasting. Agent reads feedback directly from the page.

5. Claude generates HTML wireframe via DESIGN_SKETCH matching approved direction
   Ã¢â€ â€™ Agent implements from the inspectable HTML, not the opaque PNG
```
...
Ã¢â€â€š  HEADER BAR                                                 Ã¢â€â€š
Ã¢â€â€š  "Design Exploration" . project name . "3 variants"         Ã¢â€â€š
Ã¢â€â€š  Mode indicator: [Wide exploration] | [Matching DESIGN.md]  Ã¢â€â€š
Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€Â¤
Ã¢â€â€š                                                             Ã¢â€â€š
...
Ã¢â€â€š  Ã¢â€â€š              VARIANT A (full width)                    Ã¢â€â€š  Ã¢â€â€š
Ã¢â€â€š  Ã¢â€â€š         [ mockup PNG, max-width: 1200px ]              Ã¢â€â€š  Ã¢â€â€š
Ã¢â€â€š  Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€Â¤  Ã¢â€â€š
Ã¢â€â€š  Ã¢â€â€š (Ã¢â€”Â) Pick   Ã¢Ëœâ€¦Ã¢Ëœâ€¦Ã¢Ëœâ€¦Ã¢Ëœâ€¦Ã¢Ëœâ€    [What do you like/dislike?____]   Ã¢â€â€š  Ã¢â€â€š
Ã¢â€â€š  Ã¢â€â€š            [More like this]                            Ã¢â€â€š  Ã¢â€â€š
...
Ã¢â€â€š                                                             Ã¢â€â€š
Ã¢â€â€š  Ã¢â€Å’Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€Â  Ã¢â€â€š
Ã¢â€â€š  Ã¢â€â€š              VARIANT B (full width)                    Ã¢â€â€š  Ã¢â€â€š
Ã¢â€â€š  Ã¢â€â€š         [ mockup PNG, max-width: 1200px ]              Ã¢â€â€š  Ã¢â€â€š
Ã¢â€â€š  Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€Â¤  Ã¢â€â€š
Ã¢â€â€š  Ã¢â€â€š ( ) Pick   Ã¢Ëœâ€¦Ã¢Ëœâ€¦Ã¢Ëœâ€¦Ã¢Ëœâ€ Ã¢Ëœâ€    [What do you like/dislike?____]   Ã¢â€â€š  Ã¢â€â€š
Ã¢â€â€š  Ã¢â€â€š            [More like this]                            Ã¢â€â€š  Ã¢â€â€š
Ã¢â€â€š  Ã¢â€â€Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€Ëœ  Ã¢â€â€š
Ã¢â€â€š                                                             Ã¢â€â€š
Ã¢â€â€š  ... (scroll for more variants)                             Ã¢â€â€š
Ã¢â€â€š                                                             Ã¢â€â€š
Ã¢â€â€š  Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬ separator Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬    Ã¢â€â€š
Ã¢â€â€š  Overall direction (optional, collapsed by default)         Ã¢â€â€š
Ã¢â€â€š  [textarea, 3 lines, expand on focus]                       Ã¢â€â€š
Ã¢â€â€š                                                             Ã¢â€â€š
Ã¢â€â€š  Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬ REGENERATE BAR (#f7f7f7 bg) Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬    Ã¢â€â€š
Ã¢â€â€š  "Want to explore more?"                                    Ã¢â€â€š
Ã¢â€â€š  [Totally different]  [Match my design]  [Custom: ______]   Ã¢â€â€š
Ã¢â€â€š                                          [Regenerate ->]    Ã¢â€â€š
Ã¢â€â€š  Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬  Ã¢â€â€š
Ã¢â€â€š                                        [ Ã¢Å“â€œ Submit ]         Ã¢â€â€š
...
Browse needs a persistent Chromium instance. Design is just API calls Ã¢â‚¬â€ no reason for a server. Session state for multi-turn iteration is a JSON file written to `/tmp/design-session-{id}.json` containing `previous_response_id`.
...
- Add `generateDesignSetup()` for `{{DESIGN_SETUP}}` Ã¢â‚¬â€ mirrors `generateBrowseSetup()` pattern
- Add `generateDesignMockup()` for `{{DESIGN_MOCKUP}}` Ã¢â‚¬â€ the full generate+check+present workflow
- Keeps all design resolvers in one file (consistent with existing codebase convention)

### Skill Integration (Priority Order)

**1. /office-hours** Ã¢â‚¬â€ Replace the Visual Sketch section
...
**2. /plan-design-review** Ã¢â‚¬â€ "What better looks like"
...
**3. /design-consultation** Ã¢â‚¬â€ Design system preview
...
**4. /design-review** Ã¢â‚¬â€ Design intent comparison
...
| (none Ã¢â‚¬â€ add to existing `scripts/resolvers/design.ts`) | `{{DESIGN_SETUP}}` + `{{DESIGN_MOCKUP}}` resolvers |
...
1. Read `~/.gstack/openai.json` Ã¢â€ â€™ `{ "api_key": "sk-..." }` (file permissions 0600)
2. Fall back to `OPENAI_API_KEY` environment variable
3. If neither exists Ã¢â€ â€™ guided setup flow:
...
4. If auth exists but API call fails Ã¢â€ â€™ fall back to DESIGN_SKETCH (existing HTML wireframe approach). Design mockups are a progressive enhancement, never a hard requirement.

**New command:** `$D setup` Ã¢â‚¬â€ guided API key setup + smoke test. Can be run anytime to update the key.
...
- Sequential workflow: generate variants Ã¢â€ â€™ $D compare Ã¢â€ â€™ user feedback Ã¢â€ â€™ DESIGN_SKETCH HTML wireframe
...
- You said "that isn't design" about text descriptions and ASCII art. That's a designer's instinct Ã¢â‚¬â€ you know the difference between describing a thing and showing a thing. Most people building AI tools don't notice this gap because they were never designers.
- You prioritized /office-hours first Ã¢â‚¬â€ the upstream leverage point. If the brainstorm produces real mockups, every downstream skill (/plan-design-review, /design-review) has a visual artifact to reference instead of re-interpreting prose.
- You funded Variant and immediately thought "they should have an API." That's investor-as-user thinking Ã¢â‚¬â€ you're not just evaluating the company, you're designing how their product fits into your workflow.
...
Quality score: 7/10 Ã¢â€ â€™ estimated 8.5/10 after fixes.
...
- Step 0: Scope Challenge Ã¢â‚¬â€ scope accepted as-is (full binary, user overrode reduction recommendation)
...
- Outside voice: 4 passes (Claude structured 12 issues, Codex structured 8 issues, Claude adversarial 1 fatal flaw, Codex adversarial 1 fatal flaw). Key insight: sequential PNGÃ¢â€ â€™HTML workflow resolved the "opaque raster" fatal flaw.
