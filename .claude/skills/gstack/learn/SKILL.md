...
- `/learn` (no arguments) Ã¢â€ â€™ **Show recent**
- `/learn search <query>` Ã¢â€ â€™ **Search**
- `/learn prune` Ã¢â€ â€™ **Prune**
- `/learn export` Ã¢â€ â€™ **Export**
- `/learn stats` Ã¢â€ â€™ **Stats**
- `/learn add` Ã¢â€ â€™ **Manual add**
...
2. **Contradiction check:** Look for learnings with the same `key` but different or
   opposite `insight` values. Flag: "CONFLICT: [key] has contradicting entries Ã¢â‚¬â€
