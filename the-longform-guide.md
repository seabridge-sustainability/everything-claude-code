...
```markdown
Phase 1: RESEARCH (use Explore agent) Ã¢â€ â€™ research-summary.md
Phase 2: PLAN (use planner agent) Ã¢â€ â€™ plan.md
Phase 3: IMPLEMENT (use tdd-guide agent) Ã¢â€ â€™ code changes
Phase 4: REVIEW (use code-reviewer agent) Ã¢â€ â€™ review-comments.md
Phase 5: VERIFY (use build-error-resolver if needed) Ã¢â€ â€™ done or loop back
```
...
- claude-flow Ã¢â‚¬â€ Community-built enterprise orchestration platform with 54+ specialized agents
...
- system-prompts-and-models-of-ai-tools Ã¢â‚¬â€ Community collection of AI system prompts (110k+ stars)
